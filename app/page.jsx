      ...
      <div className="w-screen min-h-screen bg-black  flex justify-center items-center ">
        <div className="lg:w-1/2 bg-white p-4 z-50 rounded-xl pt-10 aspect-[3/2]">
          ...
          <div className="flex justify-center py-8">
            <div class="relative w-2/3 min-w-[200px] h-10 border rounded-md focus-within:border-t-0">
              <input
          ...
          <div className="flex justify-center p-10">
            <button className="px-12 py-4 rounded-full bg-[#F59E0B] font-bold text-white tracking-widest uppercase transform hover:scale-105 hover:bg-[rgb(255,193,85)] transition-colors duration-200">
              Log IN / Sign Up
            </button>
          </div>
        </div>
